...
public class ToDoList extends AppCompatActivity {
    ...
    private final String DB_NAME = "my_database.db";
    ...
    private void setupDatabase() {
        db = Room.databaseBuilder(getApplicationContext(), MyDatabase.class, DB_NAME).fallbackToDestructiveMigration().build();
    }
    ...
    //@param newToDoItem new item to add in arrayList
    private void enterNewToDoItem(ToDoItem newToDoItem) {
        allToDoItems.add(newToDoItem);
        adapter.notifyDataSetChanged();
    }

    //@return date.toString() returns current date
